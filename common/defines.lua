...
military = {
	...
	SIEGE_BRIGADES_MAX = 11, -- the number of brigades above which you get no addition benefit in sieges
	...
	SIEGE_ATTRITION = 0.75, -- fixed attrition on sieging units
...
diplomacy = {
	...
	TENSION_FROM_MOVEMENT = 0.04, -- tension per 1000 in nationalist movement
	...
	CRISIS_TEMPERATURE_INCREASE = 0.5,
...
pops = {
	...
	REBEL_OCCUPATION_STRENGTH_BONUS = 0.1, -- the amount of strength given to rebel movements when they occupy a province
